...
1.17
date	94.11.24.06.29.09;	author vandys;	state Exp;
branches;
next	1.16;
...
1.12
date	93.10.19.21.09.32;	author vandys;	state Exp;
branches;
next	1.11;

1.11
date	93.10.19.00.18.36;	author vandys;	state Exp;
branches;
next	1.10;

1.10
date	93.10.18.22.56.14;	author vandys;	state Exp;
branches;
next	1.9;

1.9
date	93.10.18.19.06.04;	author vandys;	state Exp;
branches;
next	1.8;

1.8
date	93.10.18.19.05.34;	author vandys;	state Exp;
branches;
next	1.7;

1.7
date	93.09.28.00.31.24;	author vandys;	state Exp;
branches;
next	1.6;

1.6
date	93.09.27.23.10.20;	author vandys;	state Exp;
branches;
next	1.5;

1.5
date	93.09.15.01.28.19;	author vandys;	state Exp;
branches;
next	1.4;
...
1.2
date	93.08.29.21.39.11;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.08.26.08.58.45;	author vandys;	state Exp;
branches;
next	;


desc
@Block free-list management
@
...
1.11
log
@Forgot to scale bcopy by size of "struct alloc".
Also added a "freeing free node" check
@
text
@d10 1
a10 1
...
1.10
log
@Fix up printf()'s, add code to coalesce within a given freelist
element.
@
text
@d171 1
...
1.8
log
@Add debug tracing, along with bug fix for case where "fr"
is NULL after walking off end of list.
@
text
@d10 1
a10 1
...
1.7
log
@Fix missing update to a_len, leave in #ifdef'ed out debug print
@
text
@d10 2
d170 3
...
1.5
log
@Add check for 0-length allocation
@
text
@d518 4
@
...
1.2
log
@Bad test for case of no free block found
@
text
@d243 1
a243 1
