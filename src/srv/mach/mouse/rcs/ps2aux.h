...
1.1
date	94.05.30.04.01.46;	author vandys;	state Exp;
branches;
next	;
...
extern void ps2aux_coordinates(ushort x, ushort y);
extern void ps2aux_bounds(ushort x1, ushort y1, ushort x2, ushort y2);
