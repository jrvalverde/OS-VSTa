...
1.4
date	94.10.12.04.01.47;	author vandys;	state Exp;
branches;
next	1.3;
...
1.2
date	93.04.12.23.27.23;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.01.29.16.12.06;	author vandys;	state Exp;
branches;
next	;
...
1.4
log
@Default to read access for everybody
@
text
@/*
 * open.c
