...
1.3
date	94.09.26.17.10.10;	author vandys;	state Exp;
branches;
next	1.2;

1.2
date	93.02.25.18.35.42;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.01.29.16.08.29;	author vandys;	state Exp;
branches;
next	;


desc
@Machine-dependent VM definitions
@
