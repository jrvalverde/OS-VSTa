...
1.3
date	95.01.10.05.15.18;	author vandys;	state Exp;
branches;
next	1.2;
...
1.1
date	93.01.29.16.08.07;	author vandys;	state Exp;
branches;
next	;


desc
@Definition of i386 trap types
@


1.3
log
@Don't use pseudo-trap type; generates lousy code for switch
statements
@
text
@#ifndef _TRAP_H
