...
1.3
date	94.03.15.22.06.35;	author vandys;	state Exp;
branches;
next	1.2;

1.2
date	93.02.08.19.41.39;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.01.29.16.15.25;	author vandys;	state Exp;
branches;
next	;


desc
@Definitions for the underlying message passing engine
@
