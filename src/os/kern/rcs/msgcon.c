...
1.21
date	95.02.03.17.08.02;	author vandys;	state Exp;
branches;
next	1.20;

1.20
date	94.12.19.05.52.44;	author vandys;	state Exp;
branches;
next	1.19;

1.19
date	94.11.30.23.25.07;	author vandys;	state Exp;
branches;
next	1.18;

1.18
date	94.11.12.06.01.02;	author vandys;	state Exp;
branches;
next	1.17;
...
1.16
date	94.09.23.20.40.32;	author vandys;	state Exp;
branches;
next	1.15;

1.15
date	94.08.29.01.42.56;	author vandys;	state Exp;
branches;
next	1.14;

1.14
date	94.08.27.00.13.25;	author vandys;	state Exp;
branches;
next	1.13;

1.13
date	94.05.21.21.45.00;	author vandys;	state Exp;
branches;
next	1.12;
...
1.11
date	94.04.19.20.28.34;	author vandys;	state Exp;
branches;
next	1.10;
...
1.9
date	94.03.15.22.05.01;	author vandys;	state Exp;
branches;
next	1.8;
...
1.7
date	93.07.06.20.59.10;	author vandys;	state Exp;
branches;
next	1.6;
...
1.5
date	93.04.13.17.12.28;	author vandys;	state Exp;
branches;
next	1.4;

1.4
date	93.03.27.00.32.15;	author vandys;	state Exp;
branches;
next	1.3;

1.3
date	93.02.10.18.11.02;	author vandys;	state Exp;
branches;
next	1.2;

1.2
date	93.02.08.19.45.10;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.01.29.15.51.56;	author vandys;	state Exp;
branches;
next	;


desc
@Message connection/disconnection handling
@


1.21
log
@Remove client from p_prefs when shutting down a server port
@
text
@/*
 * msgcon.c
...
1.19
log
@Fix debug assertion for what can be left on a msg queue
...
1.18
log
@Remove bogus v_sema of process slot semaphore.  With that cleaned,
remove unneded reference to proc pointer.
@
text
@d78 3
a80 3
...
1.16
log
@Fix bug where M_ISR can be queued on port even though there
are no true clients.
Also, mmap() cleanup
@
text
...
1.15
log
@Fix bad assert for M_ISR messages, remove v_lock() which is
done within bounce_msgs instead
@
text
@d71 13
d86 1
...
1.13
log
@Have to delete name entry on both voluntary and involuntary
server exit
@
text
@d446 1
...
1.12
log
@Bad assert; p_maps value will not be 0 after shutdown
@
text
@d548 8
a612 8
...
1.11
log
@Forgot to free M_DISCONNECT sysmsg when done
@
text
@d576 2
a577 1
...
1.9
log
@Add name of port to port structure.  Needed to cleanly remove
port from hash map, as well as to implement msg_portname().
@
text
@d16 1
d119 1
...
1.5
log
@Clear out portref from port's list on failed open
@
text
@d16 1
a19 1
...
1.4
log
@I don't know what this was--why should a connecter delete
the server's name registry???  Mental failure.  All other
connection failure handling appears appropriate.
@
text
@d615 1
d653 2
...
1.3
log
@Get rid of dbg_enter on msg_err()
@
text
@d283 2
a284 2
...
1.2
log
@Add second arg to msg_port so caller can know name when he asks
for one.  Also, fix code for finding a port name.
@
text
@a631 1
	printf("msg_err '%s'\n", errmsg); dbg_enter();
