...
1.4
date	93.12.13.02.20.21;	author vandys;	state Exp;
branches;
next	1.3;

1.3
date	93.12.11.01.39.50;	author vandys;	state Exp;
branches;
next	1.2;

1.2
date	93.12.10.19.14.07;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.12.09.06.15.12;	author vandys;	state Exp;
branches;
next	;


desc
@Process trace support
@


1.6
log
@Don't allow debugger connections to be dup'ed.
@
text
@/*
 * ptrace.c
...
1.4
log
@Return reason for breaking when talk to debugger initially
@
text
@d21 1
a21 1
...
1.2
log
@Break get/put reg into two ops, so we have full use of args[0]
and args[1].
@
text
@d230 1
