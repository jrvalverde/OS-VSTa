...
1.2
date	94.09.30.22.54.16;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	94.09.30.21.58.02;	author vandys;	state Exp;
branches;
next	;


desc
@Create shared libraries from their -r input and database
@


1.2
log
@Rename subset syscall stub
@
text
@/*
 * mkshlib.c
