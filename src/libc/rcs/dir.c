...
1.3
date	94.04.07.00.11.37;	author vandys;	state Exp;
branches;
next	1.2;

1.2
date	93.08.17.02.17.53;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.03.25.21.29.31;	author vandys;	state Exp;
branches;
next	;
...
1.3
log
@Forgot to count the '/' between elements in size
@
text
@/*
 * dir.c
...
1.2
log
@Code assumed there was a trailing '/' on paths it was searching.
Only generally true for root!  Added code to tack one on as
necessary.
@
text
@d41 1
