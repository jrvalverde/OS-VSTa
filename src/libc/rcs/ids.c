...
1.2
date	93.05.03.21.30.18;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.04.14.01.09.23;	author vandys;	state Exp;
branches;
next	;


desc
@Symbolic interpretation of ID's and such
@
...
1.2
log
@Add routine for number->symbol conversion
@
text
@d10 1
a10 1
