...
1.2
date	94.10.13.17.54.39;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	93.04.09.17.12.43;	author vandys;	state Exp;
branches;
next	;


desc
@wait/waitpid emulation
@


1.2
log
@Fix use of wrong variable in waitpid
@
text
@/*
 * wait.c
