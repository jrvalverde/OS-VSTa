...
1.6
date	94.10.04.20.29.59;	author vandys;	state Exp;
branches;
next	1.5;

1.5
date	94.04.26.21.36.50;	author vandys;	state Exp;
branches;
next	1.4;
...
1.3
date	94.03.08.20.04.00;	author vandys;	state Exp;
branches;
next	1.2;

1.2
date	94.03.03.17.54.50;	author vandys;	state Exp;
branches;
next	1.1;

1.1
date	94.03.02.23.18.41;	author vandys;	state Exp;
branches;
next	;


desc
@Disk partition access library
@


1.6
log
@Merge Dave Hudson's fixes to -ldpart library
@
text
@/*
 * dpart.c
...
1.2
log
@Fix -Wall warnings, including real problem not returning
value from int fn.
@
text
@d109 2
